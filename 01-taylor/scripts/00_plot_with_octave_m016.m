...
print -dpng 01_functions_m016.png;
...
print -dpng 02_plot_diff_func0-func1_m016.png;
...
print -dpng 03_plot_diff_func0-func2_m016.png;
...
print -dpng 04_plot_diff_func0-func3_m016.png;
...
print -dpng 05_plot_diff_func0-func4_m016.png;


### diffs 2
plot (output_m16(:,1), abs (output_m16(:,3) - output_m16(:,4)));
ylabel ("abs (func1(x) - func2(x))");
xlabel ("arguments");
title  ("abs (func1(x) - func2(x)), M=16");
legend ("abs (func1(x) - func2(x))");
print -dpng 06_plot_diff_func1-func2_m016.png;


plot (output_m16(:,1), abs (output_m16(:,5) - output_m16(:,6)));
ylabel ("abs (func3(x) - func4(x))");
xlabel ("arguments");
title  ("abs (func3(x) - func4(x)), M=16");
legend ("abs (func3(x) - func4(x))");
print -dpng 07_plot_diff_func3-func4_m016.png;
